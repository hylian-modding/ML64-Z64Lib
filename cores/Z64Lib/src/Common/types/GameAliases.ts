import { MM_GAME, MM_SAVE, MM_GLOBAL_PTR, MM_PLAYER, MM_ACTOR_POSITION_OFFSET, MM_ACTOR_POSITION_SIZE, MM_ACTOR_ROTATION_OFFSET, MM_ACTOR_ROTATION_SIZE } from './MMAliases';
import { OOT_GAME, OOT_SAVE, OOT_GLOBAL_PTR, OOT_PLAYER, OOT_ACTOR_ROTATION_OFFSET, OOT_ACTOR_POSITION_OFFSET, OOT_ACTOR_POSITION_SIZE, OOT_ACTOR_ROTATION_SIZE } from './OotAliases';

export let Z64_GLOBAL_PTR: number;
export let Z64_SAVE: number;
export let Z64_PLAYER: number;
export let Z64_GAME: number;
export let Z64_ACTOR_ROTATION_OFFSET;
export let Z64_ACTOR_ROTATION_SIZE;
export let Z64_ACTOR_POSITION_OFFSET;
export let Z64_ACTOR_POSITION_SIZE;
